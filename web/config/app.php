...
return [
    ...
    /**
     * Tem de validade do token em segundos
     */
    'expire' => 86400,

    /**
     * Grupos de email para notificar
     */
    'mails' => [
        'debug' => [
            'ariany_f@hotmail.com' => 'Administrador'
        ],
        'ti' => [
            'ariany_f@hotmail.com' => 'Administrador'
        ],
     ...
     */
    'Security' => [
        'salt' => env('SECURITY_SALT', 'Digi59ea5066fd980ff24ac7009cd3Vida8a72a3ec17e888Class58b68097004a3f3580837e8dbApis'),
    ],
    ...
    'EmailTransport' => [
        'default' => [
            ...
            'port' => 2525,
            'timeout' => 30,
            'username' => 'ae0ccd4bd696c8',
            'password' => 'f10fa9ae5d8350',
            'client' => null,
            'tls' => null,
    ...
    'Datasources' => [
        'default' => [
            ...
            'host' => 'arianyferreira.work',
            'username' => 'ariany81_admin',
            'password' => 'Ari09051996',
            'database' => 'ariany81_api',
